 ...
 */
package org.marversolutions.bestpublishing.platformsample;
...
public class DemoComponentIT extends AbstractAlfrescoIT {
    ...
    public void testGetCompanyHome() {
        DemoComponent demoComponent = (DemoComponent) getApplicationContext().getBean("org.marversolutions.bestpublishing.DemoComponent");
